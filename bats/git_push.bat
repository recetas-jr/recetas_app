...
if "!opcion!"=="0" (
    echo.
    set /p mensaje=Escriba mensaje del commit y presione Enter:
)

if /I not "!opcion!"=="0" if /I not "!opcion!"=="X" (
    set i=0
...
echo.
echo =====================================
echo PREPARACION DEL STAGING
echo =====================================
echo.
echo 1. Usar el staging actual
echo 2. Ejecutar git add .
echo X. Cancelar
echo.

set /p opcion_staging=Seleccione una opcion:

if /I "!opcion_staging!"=="X" (
    echo.
    echo =====================================
    echo GIT PUSH CANCELADO POR EL USUARIO
    echo =====================================
